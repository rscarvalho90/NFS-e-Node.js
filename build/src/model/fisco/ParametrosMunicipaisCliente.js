...
exports.ParametrosMunicipaisCliente = void 0;
 ...
 */
class ParametrosMunicipaisCliente {
    /**
    ...
    retornaAliquotas(codigoMunicipio, codigoServico, competencia) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield axios_1.default.get("https://" + AmbienteEnum_1.ServicoEnum.SEFIN + this.ambiente + "/parametros_municipais/" + codigoMunicipio + "/" + codigoServico + "/" + competencia + "/aliquota", yield this.axiosConfig).catch((error) => { return error; });
        });
    }
    /**
    ...
    retornaHistoricoAliquotas(codigoMunicipio, codigoServico) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield axios_1.default.get("https://" + AmbienteEnum_1.ServicoEnum.SEFIN + this.ambiente + "/parametros_municipais/" + codigoMunicipio + "/" + codigoServico + "/historicoaliquotas", yield this.axiosConfig).catch((error) => { return error; });
        });
    }
    /**
    ...
    retornaConvenio(codigoMunicipio) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield axios_1.default.get("https://" + AmbienteEnum_1.ServicoEnum.SEFIN + this.ambiente + "/parametros_municipais/" + codigoMunicipio + "/convenio", yield this.axiosConfig).catch((error) => { return error; });
        });
    }
    /**
    ...
    retornaRegimesEspeciais(codigoMunicipio, codigoServico, competencia) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield axios_1.default.get("https://" + AmbienteEnum_1.ServicoEnum.SEFIN + this.ambiente + "/parametros_municipais/" + codigoMunicipio + "/" + codigoServico + "/" + competencia + "/regimes_especiais", yield this.axiosConfig).catch((error) => { return error; });
        });
    }
    /**
    ...
    retornaRetencoes(codigoMunicipio, competencia) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield axios_1.default.get("https://" + AmbienteEnum_1.ServicoEnum.SEFIN + this.ambiente + "/parametros_municipais/" + codigoMunicipio + "/" + competencia + "/retencoes", yield this.axiosConfig).catch((error) => { return error; });
        });
    }
    /**
    ...
    retornaBeneficios(codigoMunicipio, numeroBeneficio, competencia) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield axios_1.default.get("https://" + AmbienteEnum_1.ServicoEnum.SEFIN + this.ambiente + "/parametros_municipais/" + codigoMunicipio + "/" + numeroBeneficio + "/" + competencia + "/beneficio", yield this.axiosConfig).catch((error) => { return error; });
        });
    }
}
exports.ParametrosMunicipaisCliente = ParametrosMunicipaisCliente;
